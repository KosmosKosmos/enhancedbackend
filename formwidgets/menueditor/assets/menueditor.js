...
},{}],"../node_modules/sl-vue-tree/dist/sl-vue-tree.js":[function(require,module,exports) {
var define;
!function (e, t) {
  "object" == typeof exports && "object" == typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define([], t) : "object" == typeof exports ? exports.SlVueTree = t() : e.SlVueTree = t();
}(window, function () {
  return function (e) {
    var t = {};
      ...
      return s("div", {
        ...
        return s("div", {
          ...
          class: {
            ...
            "sl-vue-tree-cursor-inside": e.cursorPosition && "inside" === e.cursorPosition.placement && e.cursorPosition.node.pathStr === t.pathStr,
...
},{"./bundle-url":"../../../../../../../../../../.nvm/versions/node/v10.15.3/lib/node_modules/parcel/src/builtins/bundle-url.js"}],"../node_modules/vue-hot-reload-api/dist/index.js":[function(require,module,exports) {
var Vue // late bind
var version
var map = Object.create(null)
...
var _default = Vue;
exports.default = _default;
},{}],"VueTree.vue":[function(require,module,exports) {
"use strict";
...
var _slVueTree = _interopRequireDefault(require("sl-vue-tree"));
...
var _default = {
  ...
  mounted: function mounted() {
    for (var type in this.translations) {
  ...
  methods: {
    ...
    isDeletable: function isDeletable(node) {
    ...
    removeNode: function removeNode(node) {
      ...
      UIkit.modal.confirm(this.getTitle(node) + ' wirklich löschen?').then(function () {
        _this.$refs.slVueTree.remove([node.path]);

        _this.save();
      });
    },
    nodeDropped: function nodeDropped(nodes, position, event) {
      this.save();
    },
    toggleVisibility: function toggleVisibility(event, node) {
      var slVueTree = this.$refs.slVueTree;
      event.stopPropagation();
      var visible = !node.data || node.data.visible !== false;
    ...
    nodeToggled: function nodeToggled(node, event) {
      this.currentNode = null;
    },
    addFolder: function addFolder() {
      var slVueTree = this.$refs.slVueTree;
      var title = 'item' + slVueTree.getRoot().currentValue.length;
      var node = {
        title: title,
        isLeaf: false,
        children: [],
    ...
    setTranslations: function setTranslations(node) {
      for (var type in this.translations) {
        if (node.data[type]) {
    ...
    setLocale: function setLocale(type, code) {
      var _this2 = this;

      if (type === 'help') {
        this.translations.help.value[this.translations[type].current] = $('.field-richeditor textarea').val();
        setTimeout(function () {
          _this2.translations[type].current = code;

          _this2.richEditor.richEditor('setContent', _this2.translations.help.value[code]);
        });
      } else {
    ...
    showModal: function showModal(node) {
      ...
      setTimeout(function () {
        _this3.setTranslations(node);

        _this3.richEditor.richEditor('setContent', _this3.translations.help.value[_this3.translations.help.current]);
      }, 500);
    },
    closeModal: function closeModal() {
      var _this4 = this;

      var data = this.selectedNode.data ? this.selectedNode.data : {};
      ...
      setTimeout(function () {
        slVueTree.updateNode(_this4.selectedNode.path, {
...
exports.default = _default;
        var $6133f9 = exports.default || module.exports;
      
      if (typeof $6133f9 === 'function') {
        $6133f9 = $6133f9.options;
      }
    
        /* template */
        Object.assign($6133f9, (function () {
          var render = function() {
  var _vm = this
  ...
  return _c(
    ...
    [
      ...
      _c("sl-vue-tree", {
        ref: "slVueTree",
        attrs: { "allow-multiselect": false },
        on: { drop: _vm.nodeDropped, toggle: _vm.nodeToggled },
        scopedSlots: _vm._u([
          {
            key: "title",
            fn: function(ref) {
              var node = ref.node
              return [_vm._v(_vm._s(_vm.getTitle(node)))]
            }
          },
          {
            key: "toggle",
            fn: function(ref) {
              ...
              return [
                !node.isLeaf
                  ? _c("span", [
                      node.isExpanded
                        ? _c("i", { attrs: { "uk-icon": "album" } })
                        : _vm._e(),
                      _vm._v(" "),
                      !node.isExpanded
                        ? _c("i", { attrs: { "uk-icon": "folder" } })
                        : _vm._e()
                    ])
                  : _vm._e()
              ]
                  ...
                  _c("li", [
                    _c(
                      "span",
                      {
                        ...
                        on: {
                          click: function(event) {
                            return _vm.toggleVisibility(event, node)
                          }
                        }
                      },
                      [
                        !node.data || node.data.visible !== false
                          ? _c("i", { attrs: { "uk-icon": "laptop" } })
                          : _vm._e(),
                        _vm._v(" "),
                        node.data && node.data.visible === false
                          ? _c("i", { attrs: { "uk-icon": "ban" } })
                          : _vm._e()
                      ]
                    )
                  ])
      ...
      _c(
        "div",
        {
          ...
          attrs: { id: "modal-close-outside", "uk-modal": "" }
        },
        [
          _c("div", { staticClass: "uk-modal-dialog" }, [
            ...
            _c("div", { staticClass: "uk-modal-header" }, [
              _c("h2", { staticClass: "uk-modal-title" }, [
                _vm._v(_vm._s(_vm.getTitle(_vm.selectedNode)))
              ])
            ]),
            _vm._v(" "),
            _c("div", { staticClass: "uk-modal-body" }, [
              ...
              _c(
                ...
                [
                  _c(
                    "li",
                    _vm._l(["titles", "description", "tagList"], function(
                      field
                    ) {
                        ...
                        _c("div", { staticClass: "uk-form-controls" }, [
                          _c(
                            "div",
                            {
                              ...
                              class: { "uk-width-1-1": field !== "titles" }
                            },
                            [
                              _c(
                                "a",
                                {
                                  staticClass:
                                    "uk-form-icon uk-form-icon-flip uk-text-uppercase",
                                  attrs: { href: "" }
                                },
                                [
                                  _vm._v(
                                    "\n                                        " +
                                      _vm._s(_vm.translations[field].current) +
                                      "\n                                    "
                                  )
                                ]
                              ),
                                    ...
                                    _vm._l(_vm.locales, function(locale, code) {
                                      return _c(
                                        "li",
                                        {
                                          ...
                                          on: {
                                            click: function($event) {
                                              return _vm.setLocale(field, code)
                                            }
                                          }
                                        },
                                        [
                                ...
                                directives: [
                                  {
                                    ...
                                    rawName: "v-model",
                                    value:
                                      _vm.translations[field].value[
                                        _vm.translations[field].current
                                      ],
                                    expression:
                                      "translations[field].value[translations[field].current]"
                                  }
                                ],
                  ...
                  _c("li", [
                    _c("div", { staticClass: "uk-margin" }, [
                      _c(
                        "label",
                        { staticClass: "uk-form-label uk-width-1-1" },
                        [
                          _vm._v(
                            "\n                                " +
                              _vm._s(_vm.labels.help) +
                              "\n                                "
                          ),
                          _c(
                            "div",
                            { staticClass: "uk-inline uk-float-right" },
                            [
                              _c(
                                "span",
                                {
                                ...
                                [
                                  _vm._v(
                                    "\n                                " +
                                      _vm._s(_vm.translations.help.current) +
                                      "\n                            "
                                  )
                                ]
                              ),
                                    ...
                                    _vm._l(_vm.locales, function(locale, code) {
                                      return _c(
                                        "li",
                                        {
                                          ...
                                          on: {
                                            click: function($event) {
                                              return _vm.setLocale("help", code)
                                            }
                                          }
                                        },
                                        [
                      ...
                      _c(
                        "div",
                        { staticClass: "uk-form-controls uk-width-1-1" },
                        [
                          _c(
                            "div",
                            {
                              staticClass: "field-richeditor size-large ",
                              attrs: {
                                "data-use-media-manager": "true",
                                "data-editor-lang": "de",
                                "data-links-handler":
                                  "formMenuItems::onLoadPageLinksForm",
                            ...
                            [
                              _c("textarea", {
                                attrs: { placeholder: _vm.labels.help }
                              }),
                              _vm._v(" "),
                              _c("div", { staticClass: "height-indicator" })
                            ]
                          )
                        ]
                      )
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("ul", { attrs: { "data-uk-tab": "{connect:'#my-id'}" } }, [
      _c("li", { staticClass: "uk-active" }, [
        _c("a", { attrs: { href: "" } }, [_vm._v("Allgemein")])
      ]),
      _vm._v(" "),
      _c("li", [_c("a", { attrs: { href: "" } }, [_vm._v("Hilfe")])])
    ])
  }
]
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$6133f9', $6133f9);
          } else {
            api.reload('$6133f9', $6133f9);
          }
        }
...
},{"sl-vue-tree":"../node_modules/sl-vue-tree/dist/sl-vue-tree.js","_css_loader":"../../../../../../../../../../.nvm/versions/node/v10.15.3/lib/node_modules/parcel/src/builtins/css-loader.js","vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.runtime.esm.js"}],"menueditor.scss":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"../../../../../../../../../../.nvm/versions/node/v10.15.3/lib/node_modules/parcel/src/builtins/css-loader.js"}],"menueditor.js":[function(require,module,exports) {
"use strict";

var _vue$ = _interopRequireDefault(require("vue$"));

var _VueTree = _interopRequireDefault(require("./VueTree"));
...
setTimeout(function () {
  new _vue$.default({
    el: '#vue-app',
    components: {
      'vue-tree': _VueTree.default
    },
    data: {
      loading: true
    },
    methods: {
      onLoaded: function onLoaded(loaded) {
        this.loading = !loaded;
      }
    }
  });
}, 2000);
},{"vue$":"../node_modules/vue/dist/vue.esm.js","./VueTree":"VueTree.vue","./menueditor.scss":"menueditor.scss"}],"../../../../../../../../../../.nvm/versions/node/v10.15.3/lib/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../../../../../../../../../.nvm/versions/node/v10.15.3/lib/node_modules/parcel/src/builtins/hmr-runtime.js","menueditor.js"], null)
